...
public partial class @PlayerInputActions: IInputActionCollection2, IDisposable
{
    ...
    private List<IAllTerainActions> m_AllTerainActionsCallbackInterfaces = new List<IAllTerainActions>();
    ...
    public struct AllTerainActions
    {
        ...
        public void AddCallbacks(IAllTerainActions instance)
        {
            if (instance == null || m_Wrapper.m_AllTerainActionsCallbackInterfaces.Contains(instance)) return;
            m_Wrapper.m_AllTerainActionsCallbackInterfaces.Add(instance);
        ...
        private void UnregisterCallbacks(IAllTerainActions instance)
        {
            @Interact.started -= instance.OnInteract;
            @Interact.performed -= instance.OnInteract;
            @Interact.canceled -= instance.OnInteract;
        ...
        public void RemoveCallbacks(IAllTerainActions instance)
        {
            if (m_Wrapper.m_AllTerainActionsCallbackInterfaces.Remove(instance))
                UnregisterCallbacks(instance);
        }

        public void SetCallbacks(IAllTerainActions instance)
        {
            foreach (var item in m_Wrapper.m_AllTerainActionsCallbackInterfaces)
                UnregisterCallbacks(item);
            m_Wrapper.m_AllTerainActionsCallbackInterfaces.Clear();
            AddCallbacks(instance);
        }
    }
    ...
    private List<IKiteMovementActions> m_KiteMovementActionsCallbackInterfaces = new List<IKiteMovementActions>();
    ...
    public struct KiteMovementActions
    {
        ...
        public void AddCallbacks(IKiteMovementActions instance)
        {
            if (instance == null || m_Wrapper.m_KiteMovementActionsCallbackInterfaces.Contains(instance)) return;
            m_Wrapper.m_KiteMovementActionsCallbackInterfaces.Add(instance);
            @Horizontal.started += instance.OnHorizontal;
            @Horizontal.performed += instance.OnHorizontal;
            @Horizontal.canceled += instance.OnHorizontal;
        }

        private void UnregisterCallbacks(IKiteMovementActions instance)
        {
            @Horizontal.started -= instance.OnHorizontal;
            @Horizontal.performed -= instance.OnHorizontal;
            @Horizontal.canceled -= instance.OnHorizontal;
        ...
        public void RemoveCallbacks(IKiteMovementActions instance)
        {
            if (m_Wrapper.m_KiteMovementActionsCallbackInterfaces.Remove(instance))
                UnregisterCallbacks(instance);
        }

        public void SetCallbacks(IKiteMovementActions instance)
        {
            foreach (var item in m_Wrapper.m_KiteMovementActionsCallbackInterfaces)
                UnregisterCallbacks(item);
            m_Wrapper.m_KiteMovementActionsCallbackInterfaces.Clear();
            AddCallbacks(instance);
        }
    }
    ...
    private List<IGlobleKeysActions> m_GlobleKeysActionsCallbackInterfaces = new List<IGlobleKeysActions>();
    ...
    public struct GlobleKeysActions
    {
        ...
        public void AddCallbacks(IGlobleKeysActions instance)
        {
            if (instance == null || m_Wrapper.m_GlobleKeysActionsCallbackInterfaces.Contains(instance)) return;
            m_Wrapper.m_GlobleKeysActionsCallbackInterfaces.Add(instance);
        ...
        private void UnregisterCallbacks(IGlobleKeysActions instance)
        {
            @PauseUnpause.started -= instance.OnPauseUnpause;
            @PauseUnpause.performed -= instance.OnPauseUnpause;
            @PauseUnpause.canceled -= instance.OnPauseUnpause;
        ...
        public void RemoveCallbacks(IGlobleKeysActions instance)
        {
            if (m_Wrapper.m_GlobleKeysActionsCallbackInterfaces.Remove(instance))
                UnregisterCallbacks(instance);
        }

        public void SetCallbacks(IGlobleKeysActions instance)
        {
            foreach (var item in m_Wrapper.m_GlobleKeysActionsCallbackInterfaces)
                UnregisterCallbacks(item);
            m_Wrapper.m_GlobleKeysActionsCallbackInterfaces.Clear();
            AddCallbacks(instance);
        }
    }
